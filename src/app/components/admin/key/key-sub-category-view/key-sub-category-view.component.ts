...
export class KeySubCategoryViewComponent implements OnInit {
  ...
  constructor(
    private keySubCategoryService: KeySubCategoryService,
  ...
  getAllKeySubCategoryByKeyCategory(): void {
    this.keySubCategoryService
      .findByKeyCategory(this.keyBehaviorService.get())
      .subscribe((resp) => {
  ...
  loadKeyCardView(): void {
    const keyCardView: ComponentRef<KeyCardComponent> =
